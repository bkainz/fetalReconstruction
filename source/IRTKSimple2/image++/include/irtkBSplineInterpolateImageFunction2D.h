/*=========================================================================
  ...
  Module    : $Id: irtkBSplineInterpolateImageFunction2D.h 8 2009-03-02 16:12:58Z dr $
...
#ifndef _IRTKBSPLINEINTERPOLATEIMAGEFUNCTION2D_H

#define _IRTKBSPLINEINTERPOLATEIMAGEFUNCTION2D_H
...
public:
  ...
  irtkBSplineInterpolateImageFunction2D(int = 3);

  /// Destructor
  ~irtkBSplineInterpolateImageFunction2D();

/*=========================================================================
  ...
  Module    : $Id: irtkImageFluidRegistration2D.h 2 2008-12-23 12:40:14Z dr $
...
#ifndef _IRTKIMAGEFLUIDREGISTRATION2D_H

#define _IRTKIMAGEFLUIDREGISTRATION2D_H
...
class irtkImageFluidRegistration2D : public irtkImageFluidRegistration
{
...
inline const char *irtkImageFluidRegistration2D::NameOfClass()
{
  return "irtkImageFluidRegistration2D";
}

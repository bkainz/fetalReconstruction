/*=========================================================================
  ...
  Module    : $Id: irtkImageFreeFormRegistration.h 304 2011-04-10 21:46:30Z ws207 $
...
#ifndef _IRTKIMAGEFREEFORMREGISTRATION_H

#define _IRTKIMAGEFREEFORMREGISTRATION_H
...
class irtkImageFreeFormRegistration : public irtkImageRegistration
{
...
inline const char *irtkImageFreeFormRegistration::NameOfClass()
{
  return "irtkFreeFormRegistration";
}

inline void irtkImageFreeFormRegistration::Print()
{}

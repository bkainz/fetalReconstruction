/*=========================================================================
  ...
  Module    : $Id: irtkSymmetricImageFreeFormRegistration.cc 882 2013-05-16 13:02:11Z kpk09 $
  Copyright : Imperial College, Department of Computing
              Visual Information Processing (VIP), 2008 onwards
  Date      : $Date: 2013-05-16 14:02:11 +0100 (Thu, 16 May 2013) $
  ...
  for (k = 0; k < _affd1->GetZ(); k++) {
    for (j = 0; j < _affd1->GetY(); j++) {
      for (i = 0; i < _affd1->GetX(); i++) {
		...
		jacobian = _affd1->irtkTransformation::Jacobian(x, y, z);
		if (jacobian < 0.001)
			jacobian = 0.001;

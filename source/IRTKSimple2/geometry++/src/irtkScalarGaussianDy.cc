/*=========================================================================
  ...
  Module    : $Id: irtkScalarGaussianDy.cc 62 2009-05-28 13:19:03Z dr $
...
irtkScalarGaussianDy::irtkScalarGaussianDy(double _sigma_x, double _sigma_y, double _sigma_z, double x_0, double y_0, double z_0)
{
  _Sigma_x = _sigma_x;
  _Sigma_y = _sigma_y;
  _Sigma_z = _sigma_z;
  ...
  if ((_Sigma_x != 0) && (_Sigma_y != 0) && (_Sigma_z != 0)){
    ...
    cerr << "irtkScalarGaussianDy::irtkScalarGaussianDy: Warning, divide by zero" << endl;
    _Factor = 0.0;
  }
...
double irtkScalarGaussianDy::Evaluate(double x, double y, double z)
{
  ...
  return - (1.0 / _VarY) * _Factor * _Exp * (y - _Y_0);
}
